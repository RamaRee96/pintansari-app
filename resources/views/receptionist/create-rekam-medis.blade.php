  ...
  <div class="w-full flex justify-around px-5">
    ...
    <div class="w-full lg:w-1/2 my-6 pr-0 lg:pr-2">
      ...
      <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{ route('patients_store') }}">
          @method("POST")
          @csrf
          ...
          <div class="mt-2">
            ...
            <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="name" name="nama" type="text"
              required="" placeholder="Enter Nama" aria-label="Name">
          </div>
          <div class="mt-2">
            ...
            <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="usia" name="usia" type="number"
              required="" placeholder="Enter Usia" aria-label="Usia">
          </div>
          <div class="flex">
            <div class="mt-2">
              ...
              <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="tanggalLahir" name="tanggal_lahir"
                type="date" required="" placeholder="Enter Tanggal Lahir" aria-label="Tanggal Lahir">
            </div>
            <div class="flex flex-col ml-2">
              <label class="block text-sm text-gray-600 mt-2" for="email">Jenis Kelamin</label>
              <div class="flex items-center justify-center h-full w-full">
                <input type="radio" value="pria" name="jenis_kelamin" id="jenis-kelamin">
                <label class="ml-2 block text-sm text-gray-600" for="email">Pria</label>
                <input class="ml-4" type="radio" value="wanita" name="jenis_kelamin" id="jenis-kelamin">
          ...
          <div class="mt-2">
            ...
            <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="pekerjaan" name="pekerjaan"
              type="text" required="" placeholder="Enter Pekerjaan" aria-label="Pekerjaan">
          </div>
          <div class="mt-2">
            <label class="block text-sm text-gray-600" for="email">No Telepon</label>
            <input class="w-full px-5  py-1 text-gray-700 bg-gray-200 rounded" id="noTelp" name="no_telp" type="number"
              required="" placeholder="Enter No Telepon" aria-label="No Telepon">
          </div>
          <div class="mt-2">
