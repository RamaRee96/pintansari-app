  ...
  <main class="w-full h-screen flex-grow p-6 mb-32">
    ...
    <h2 class="text-2xl text-gray-500 pb-2">Data Rekam Medis</h2>
      ...
      <div class="grid gap-6 mb-6 md:grid-cols-2">
       ...
       <div class="mb-6">
          <label for="tanggal_periksa" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
            Tanggal Periksa
          </label>
          <input type="text" id="tanggal_periksa"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Flowbite" value="{{ $data->created_at->format('d-m-Y') }}" readonly>
        </div>
      <div class="mb-6">
