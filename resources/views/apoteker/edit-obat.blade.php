    ...
    <form method="POST" action="{{ route('updateObat', ['id' => $obat->id]) }}">
      ...
      <div class="mb-6">
        ...
        <input type="text" id="nama"
          ...
          placeholder="Nama Obat" name="nama" value="{{ $obat->nama }}" required>
      </div>
      <div class="mb-6">
        ...
        <textarea id="kandungan" rows="4"
          ...
          placeholder="Tuliskan Kandungan Obat Disini..." name="kandungan" required>{{ $obat->kandungan }}</textarea>
      ...
      <div class="mb-6">
        ...
        <input type="number" id="harga"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          placeholder="Harga Obat" name="harga" value="{{ $obat->harga }}" required>
      </div>
      <div class="mb-6">
        <label for="stock" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Stock Obat</label>
        <input type="number" id="stock"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          placeholder="Stock Obat" name="stock" value="{{ $obat->stock }}" required>
      </div>
      <div class="mb-6">
        ...
        <select id="status" name="status"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
          @if($obat->status)
          <option value="{{ $obat->status }}" selected>{{ $obat->status }}</option>
          @endif
