@extends('layouts.app', ['title' => 'Dashboard - Resepsionis'])
@section('content')
...
<div class="w-full overflow-x-hidden border-t flex flex-col">
    ...
    <div class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400"
        role="alert">
        <span class="font-medium">Sukses</span> Berhasil Menghapus Resepsionis
    </div>
    @endif
        <h1 class="text-3xl text-black pb-6">Resepsionis</h1>

        <h2 class="text-2xl text-gray-500 pb-2"> Data Resepsionis</h2>
        <a href="/admin/tambahResepsionis">
            <button type="button"
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <div
                class="flex items-center  flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-4 bg-gray-100 dark:bg-gray-900 justify-end">   
                ...
                <form class="relative">
                    ...
                    <input type="text" id="table-search-users" name="q"
                        ...
                        placeholder="Search for resepsionis">
                </form>
            </div>
