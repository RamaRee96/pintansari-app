    ...
    <div class="w-full lg:w-1/2 my-6 pr-0 lg:pr-2">
      ...
      <div class="leading-loose">
        <p class="text-xl py-5 px-5 mt-6 flex items-center">
          <i class="fas fa-user mr-3"></i> Dokter Baru
        </p>
        <form class="p-10 bg-white rounded shadow-xl" action="{{ route('store_dokter') }}" method="POST">
          @method('POST')
          @csrf
          ...
          <div class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 mt-3"
            role="alert">
            <span class="font-medium">Sukses!</span> Dokter Berhasil Di Tambahkan
          </div>
          @endif
          <div class="mt-2">
