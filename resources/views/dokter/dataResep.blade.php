...
<div class="w-full overflow-x-hidden border-t flex flex-col">
  <main class="w-full h-screen flex-grow p-6">
      <h1 class="text-3xl text-black pb-6">Resep Obat</h1>

      <h2 class="text-2xl text-gray-500 pb-2">Data Resep Obat</h2>
